...
const ItemCard = ({ product }) => {
  ...
  const { image, productName, location, resalePrice, originalPrice, usesYears, category, userName, condition, mobile, description, report, reportEmail, badge } = product;
    ...
    <div className="card card-compact bg-white hover:shadow-xl">
      ...
      <div className="card-body text-left gap-0">
        ...
        <div className="card-actions justify-between mt-3">
          <Link className="btn btn-primary btn-sm text-white">Book Now</Link>
          {
