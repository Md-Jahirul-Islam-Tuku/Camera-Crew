    ...
    <footer className="px-4 divide-y bg-primary text-white">
      <div className="container flex flex-col justify-around py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="flex justify-center space-x-4">
          <Link to='/' rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white text-primary">
          ...
          <Link to='/' className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white text-primary">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-6 h-6">
      ...
      <div className="py-6 text-sm text-center text-white">© 2022 Camera Crew. All rights reserved.</div>
    </footer>
  );
};
